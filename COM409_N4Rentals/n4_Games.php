...
//This product data can be SELECTed here according to the category type.. in his case it is for Games
$sql = "SELECT * FROM Products WHERE Category='Games' ORDER BY Product_ID DESC";
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-header">
					<h1 id="forms"><img src="images/N4_Title.png" width="210" height="35"> Games!</h1>
				</div>
			</div>
		</div>
