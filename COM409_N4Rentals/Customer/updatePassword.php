			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="well bs-component">
						<form action="updatePasswordProc.php?CustID=<?php echo$row['id'];?>" method="POST" name="changePass" onsubmit="return validateChangePass()"  class="form-horizontal">
							...
							<fieldset>			
									<div class="form-group">
										<label for="inputFName" class="col-lg-6 col-md-6 control-label">Current Password:<font color="red">*</font></label>
										<div class="col-lg-6 col-md-6">
...
function validateChangePass() {
	var x = document.forms["changePass"]["currentPass"].value;
	if (x == null || x == "") {
